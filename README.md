...
<span style="color:red"> To run CookHLA, move the appropriate **mach1** binary file for your operating system (Linux or macOS) on ./CookHLA/dependency directory.</span> <br/>
